...
var firstDate = new Date("July 21, 2017 00:00:00");var secondDate = new Date();
...
}}}if(s[0].innerHTML <= -1) {clearInterval(i);document.getElementsByTagName('div')[0].innerHTML='<h2>Time to fly!</h2>'}}